...
public class ResideMenu extends FrameLayout {
    ...
    private void showScrollViewMenu(View scrollViewMenu2) {
        if (scrollViewMenu2 != null && scrollViewMenu2.getParent() == null) {
            addView(scrollViewMenu2);
        }
    }

    private void hideScrollViewMenu(View scrollViewRightMenu2) {
        if (scrollViewRightMenu2 != null && scrollViewRightMenu2.getParent() != null) {
            removeView(scrollViewRightMenu2);
        }
    }
}
