...
public class CollecMessFrg extends Fragment implements OnClickListener,
		OnItemClickListener, OnItemLongClickListener {
	private boolean isSeting;
	private CollectActivity activity;
	private View layout;
	private CollecMesAdapter adapter;
	...
	public View onCreateView(LayoutInflater inflater,
		...
		// 解析布局
		View v = inflater.inflate(R.layout.collec_mes, container, false);
		listView = (ListView) v.findViewById(R.id.lv_collec);
		// 设置item点击
		listView.setOnItemClickListener(this);
		listView.setOnItemLongClickListener(this);
		layout = v.findViewById(R.id.layout_collect);
		// 从数据库获取数据
		...
		adapter = new CollecMesAdapter(datas, getActivity());
