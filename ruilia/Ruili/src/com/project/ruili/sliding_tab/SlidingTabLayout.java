package com.project.ruili.sliding_tab;
...
public class SlidingTabLayout extends HorizontalScrollView {
	...
	private boolean isCenterModel;// 是否设置3栏平均模式
	...
	public void setCenterModel(boolean isCenterModel) {
		this.isCenterModel = isCenterModel;
	}
	...
	private void populateTabStrip() {
		...
		for (int i = 0; i < adapter.getCount(); i++) {
			...
			if (mTabViewLayoutId != 0) {
				...
				if (isCenterModel) {
					...
					LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(
							width / 3-20, LayoutParams.WRAP_CONTENT);
					params.setMargins(10, 0, 10, 0);
					tabTitleView.setLayoutParams(params);
				}
			}
			...
			if(isFashion){
				LinearLayout.LayoutParams lp = (LinearLayout.LayoutParams) tabTitleView
						.getLayoutParams();
				lp.width = 0;
				lp.weight = 1;
			}
			...
			if(isFashion){
				...
				tabTitleView.setTextColor(0xffffffff);
			}
	...
	public void layoutTag(boolean isFashion){
